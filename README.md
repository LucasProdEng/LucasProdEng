  ...
  <tr>
    ...
    <td valign="top">
      ...
      <ul>
        ...
        <li>Strong background in cloud platforms, observability practices, and automation workflows.</li>
        <li>Committed to designing resilient systems and continuously improving system performance and reliability.</li>
      </ul>
...
[![My Skills](https://skillicons.dev/icons?i=js,react,nodejs,ts,angular,git)](https://skillicons.dev)
